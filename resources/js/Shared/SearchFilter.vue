<template>
  <div class="flex items-center">
    <div class="flex w-full bg-white shadow rounded">
      <dropdown class="px-4 md:px-6 rounded-l border-r hover:bg-gray-200 focus:border-white focus:shadow-outline focus:z-10" placement="bottom-start">
    ...
    <button class="ml-3 text-sm text-gray-600 hover:text-gray-700 focus:text-green-500" type="button" @click="$emit('reset')">Reset</button>
  </div>
</template>
